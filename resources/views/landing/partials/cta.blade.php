...
<section id="cta" class="py-24 bg-gradient-to-br from-green-600 via-green-700 to-green-800 relative overflow-hidden">
    <!-- Background Image -->
    <div class="absolute inset-0">
        <img src="{{ asset('illustration/customizable-flat-illustration-code-optimization_203633-8821.jpg') }}" alt="" class="w-full h-full object-cover opacity-20">
        <div class="absolute inset-0 bg-gradient-to-br from-green-600/90 via-green-700/90 to-green-800/90"></div>
    </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-4xl mx-auto text-center" data-aos="fade-up">
            ...
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
                ...
                <span class="text-yellow-400">Digital Infrastructure?</span>
            </h2>
            
            <p class="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
                Let's discuss how Glovin Limited can help you achieve your technology goals. Schedule a free consultation with our experts today.
            </p>
