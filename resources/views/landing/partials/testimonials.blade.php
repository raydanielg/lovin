...
<section id="testimonials" class="py-24 bg-gradient-to-br from-green-50 to-yellow-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16" data-aos="fade-up">
            ...
            <p class="text-gray-600">Hear from the organizations that have transformed their operations with our solutions.</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 relative" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-sm text-gray-500">CTO, Leading Bank</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 relative" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="font-semibold text-gray-900">Dr. Sarah Nkosi</div>
                        <div class="text-sm text-gray-500">Director of Health Services</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 relative" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="font-semibold text-gray-900">Alex Oduor</div>
                        <div class="text-sm text-gray-500">IT Director, Government Agency</div>
                    </div>
                </div>
            </div>
        </div>
