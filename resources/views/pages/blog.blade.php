...
<head>
    ...
    <title>Insights & Blog - Glovin Limited</title>
    ...
    <section class="pt-32 pb-16 bg-gradient-to-br from-green-900 via-green-800 to-green-900">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center" data-aos="fade-up">
                <h1 class="text-4xl sm:text-5xl font-bold text-white mb-4">Insights & Blog</h1>
                <p class="text-xl text-gray-300 max-w-2xl mx-auto">Latest news, trends, and insights from the tech industry</p>
