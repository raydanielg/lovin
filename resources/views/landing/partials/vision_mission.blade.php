...
<section id="vision-mission" class="py-24 bg-gradient-to-br from-gray-50 to-green-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16" data-aos="fade-up">
            ...
            <p class="text-gray-600">Driving Africa's digital transformation through innovative technology solutions</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="group relative" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="relative bg-white rounded-2xl p-8 border border-gray-100 h-full">
                    ...
                    <p class="text-gray-600 leading-relaxed text-lg">
                        Glovin's mission is to provide timely, tailored, and high-quality solutions that protect client interests while addressing both technological and commercial challenges in a rapidly evolving digital landscape.
                    </p>
