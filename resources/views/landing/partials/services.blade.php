...
<section id="services" class="py-24 bg-gradient-to-br from-green-900 via-green-800 to-green-900 relative overflow-hidden">
    <!-- Background Pattern -->
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16" data-aos="fade-up">
            ...
            <p class="text-gray-300">Comprehensive technology solutions designed to transform your business operations</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <!-- ICT Infrastructure -->
            <div class="group bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all" data-aos="fade-up" data-aos-delay="500">
                <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center mb-6 shadow-lg">
            ...
            <div class="group bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all" data-aos="fade-up" data-aos-delay="600">
                <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-600 flex items-center justify-center mb-6 shadow-lg">
